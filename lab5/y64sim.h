...
typedef enum
{
	I_HALT = 0, I_NOP, I_RRMOVQ, I_IRMOVQ, I_RMMOVQ, I_MRMOVQ,
	I_ALU, I_JMP, I_CALL, I_RET, I_PUSHQ, I_POPQ, I_DIRECTIVE
} itype_t;
...
#define VAIDCOND(cd) !(cd > 6)

/* Directive code */
typedef enum
{
	D_DATA, D_POS, D_ALIGN
} dtv_t;
